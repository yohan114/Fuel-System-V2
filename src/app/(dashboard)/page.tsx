        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-[#121420] border border-white/5 rounded-2xl p-6 shadow-lg">
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              ...
              {isAdmin && <Link href="/service/analytics" className="text-[11px] bg-white/5 hover:bg-white/10 border border-white/5 rounded-lg px-3 py-1.5 text-gray-300">Service Trends</Link>}
